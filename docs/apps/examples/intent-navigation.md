...
* [\ulkCreate.launch\](https://www.canva.dev/docs/apps/api/latest/design-bulk-create-launch/)
...
* [\publish.launch\](https://www.canva.dev/docs/apps/api/latest/design-publish-launch/)
