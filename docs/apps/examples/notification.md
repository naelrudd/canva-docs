Source: https://www.canva.dev/docs/apps/examples/notification/
...
* [\
otification.addToast\](https://www.canva.dev/docs/apps/api/latest/platform-notification-add-toast/)
